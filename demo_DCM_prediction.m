...
dataName = 'swissmetro_varalt_shuffled_groups_easyfakespec1';
...
Xts = cell(3,1);
for c=1:nChoices
	Xtr{c} = X_fake{c}(1:Ntr,:);
    Xts{c} = X_fake{c}((Ntr+1):end,:);
end
Ytr = Y(1:Ntr,:);
...
fileID = fopen([outdir dataName '_dcm_mle_accuracy.txt'],'w');
